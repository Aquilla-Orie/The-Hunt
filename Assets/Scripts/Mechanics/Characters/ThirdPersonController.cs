...
//Used the default Unity's ThirdPersonController scrip as a base for the character controller.
...
namespace StarterAssets
{
    ...
    {
        [Tooltip("Camera object for this player")]
        ...
        /// <summary>
        /// Turn off the camera of other players in the scene to avoid camera swapping.
        /// RPC tells other clients to do the same for us as well.
        /// </summary>

        [PunRPC]
        public void DisableOtherCameras()
        {
            var otherPlayers = FindObjectsOfType<ThirdPersonController>();

            //Disable the cameras of all other players
            foreach (var otherPlayer in otherPlayers)
            {
                otherPlayer.MyCamera.SetActive(false);
            }
